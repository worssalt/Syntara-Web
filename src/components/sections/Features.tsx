      ...
      <div className="container px-6 mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {features.map((feature, index) => (
            <div 
              key={index} 
              className="relative h-full bg-neutral-900/60 backdrop-blur-md rounded-3xl p-5 md:p-8 border border-white/5 overflow-hidden group hover:bg-neutral-900/80 transition-colors duration-500"
            >
              ...
              {/* Icon */}
              <div className={`w-14 h-14 rounded-2xl ${feature.color === 'green' ? 'bg-syntara-green/10 text-syntara-green' : 'bg-syntara-cyan/10 text-syntara-cyan'} flex items-center justify-center mb-4 md:mb-8 relative z-10 shadow-[0_0_20px_rgba(0,0,0,0.5)] border border-white/5`}>
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col items-start mt-auto">
                  <div className={`text-3xl md:text-5xl font-bold ${feature.color === 'green' ? 'text-syntara-green' : 'text-syntara-cyan'} mb-2 drop-shadow-[0_0_10px_rgba(0,0,0,0.5)]`}>
                    {feature.statValue}
                  </div>
