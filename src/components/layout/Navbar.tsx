          ...
          >
            <div className="container mx-auto px-6 py-6 flex flex-col gap-4">
              ...
              <div className="flex items-center justify-center gap-8 mt-4 pt-6 border-t border-white/10">
                <a href="https://linkedin.com/company/syntarabiz" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-syntara-cyan transition-colors">
                  <Linkedin className="w-6 h-6" />
                </a>
                <a href="https://instagram.com/syntara.biz" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-syntara-cyan transition-colors">
                  <Instagram className="w-6 h-6" />
                </a>
                <a href="https://wa.me/51970216616?text=Hola%20Syntara%2C%20quiero%20informaci%C3%B3n%20sobre%20sus%20servicios" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-syntara-cyan transition-colors">
